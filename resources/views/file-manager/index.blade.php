                ...
                <div class="gerenciador flex-1 overflow-scroll">
                        ...
                        <form action="{{ route('file-manager.deldir', ['folder' => $dir['id']]) }}" method="POST" class="row lista-arquivos">
                            ...
                            <div class="row py-1 px-4">
                                <div class="col-md-7 col-12">
                                    <a class="text-cinza text-decoration-none d-flex align-items-center" href="{{ url('/file-manager/') }}@php echo '/'.$dir['pasta'] @endphp">
                    ...
                    @foreach ($data as $file)
                        <form action="{{ route('file-manager.destroy', ['file' => $file['id']]) }}" method="POST" class="row lista-arquivos">
                            ...
                            <div class="row py-1 px-4">
                                <div class="col-md-7 col-12">
                                    <a href="#!" class="text-black text-decoration-none info d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#Pic{{$file['id']}}">
                                        <span class="material-symbols-outlined symbol-filled text-cinza">draft</span> {{$file['arquivo']}}
                                    </a>
                                </div>
                                ...
                                <div class="col-md-2 col-12 d-flex align-items-center justify-content-end">
                                    ...
                                    <a href="{{ url('/')}}{{$directory.$file['arquivo'] }}" download="{{$file['arquivo']}}" class="d-inline-flex align-items-center justify-content-center mx-1">
                                        <span class="material-symbols-outlined text-azul me-1">download</span>
                                    </a>
